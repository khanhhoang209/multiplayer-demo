...
namespace RMC.Playground2D.Shared.Multiplayer
{
    ...
    {
        [SerializeField]
        private string hostIP = "192.168.1.209";
        ...
        protected void Update()
        {
            if (!NetworkManager.Singleton.IsClient)
            {
                ...
                if (Input.GetKeyDown(KeyCode.H))
                {
                    ...
                    Debug.Log($"Starting as Host on IP: {transport.ConnectionData.Address}, Port: {port}");
                ...
                else if (Input.GetKeyDown(KeyCode.C))
                {
                    ...
                    Debug.Log($"Starting as Client on IP: {transport.ConnectionData.Address}, Port: {port}");
                }
            }
            else
            {
